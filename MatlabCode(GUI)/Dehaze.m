...
% Last Modified by GUIDE v2.5 02-Jun-2010 01:47:50
...
% --- Executes just before Dehaze is made visible.
function Dehaze_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Dehaze (see VARARGIN)

% Choose default command line output for Dehaze
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Dehaze wait for user response (see UIRESUME)
...
ext  = get(handles.edit2,'string');
I=imread(name{1},ext{1});
figure;
imshow(I);
% hObject    handle to pushbutton1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
